    ...
    return (
        <div className='flex flex-col'>
            <div className='flex justify-between mx-2'>
                ...
                <div className='flex justify-evenly items-center w-[140px] h-[40px] rounded-xl bg-[#1F3641]'>
                    {activeMark === 'X' ?
                        <span className='text-sm text-[#A8BFC9]'><svg width="64" height="64" className='inline game-icon' xmlns="http://www.w3.org/2000/svg"><path d="M15.002 1.147 32 18.145 48.998 1.147a3 3 0 0 1 4.243 0l9.612 9.612a3 3 0 0 1 0 4.243L45.855 32l16.998 16.998a3 3 0 0 1 0 4.243l-9.612 9.612a3 3 0 0 1-4.243 0L32 45.855 15.002 62.853a3 3 0 0 1-4.243 0L1.147 53.24a3 3 0 0 1 0-4.243L18.145 32 1.147 15.002a3 3 0 0 1 0-4.243l9.612-9.612a3 3 0 0 1 4.243 0Z" fill="#A8BFC9" /></svg>TURN</span>
                        :
                ...
                <div className='flex items-center bg-[#A8BFC9] p-3 rounded-xl'>
